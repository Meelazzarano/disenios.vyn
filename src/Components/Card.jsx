  ...
  return (
    <>
        <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
            ...
            <Link to={`/Productos/${item.id}`} className="my-6 inline-flex text-gray-400 bg-gray-800 border-0 py-1 px-6 focus:outline-none hover:bg-gray-700 rounded text-lg">Ver detalles</Link>
        </div>
    </>
  )
}
