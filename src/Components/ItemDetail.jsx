                ...
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div className="block">
                        {   cartQuantity ===0 ?
                            ...
                            : <Link to='/Cart' className=" m-3 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded">Terminar la compra</Link>
                        }
                        <button className="block mx-3 my-10 text-white text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 rounded"><Link to='/Productos'>Volver a Productos</Link></button>
                    </div>
                </div>
            </div>
        </div>
